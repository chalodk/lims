...
const CONTACT_WHATSAPP_URL =
  'https://wa.me/56997023645?text=Hola%2C%20vi%20la%20plataforma%20LIMS%20que%20desarrollaron.%20Me%20interesa%20saber%20m%C3%A1s%20de%20ustedes'

export default function NemachileLoginScreen() {
  const {
    email,
    setEmail,
    password,
      ...
      <div className="max-w-md w-full mx-4">
        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 space-y-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 mt-1">Accede a tu cuenta del laboratorio</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : <span>Iniciar sesión</span>}
            </button>
          </form>
        </div>
